...
<head>
  <meta charset="utf-8" />
  <title>Buscar Cliente - Veterinaria Tessa</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link active" href="buscar_cliente.php"><i class="bi bi-search-heart"></i> Buscar Cliente</a></li>
            ...
            <table class="table table-bordered text-center align-middle">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Rocky</td>
                  <td>
                    <a href="ver_cliente.php?id=1" class="btn btn-outline-warning btn-sm">
                      <i class="bi bi-eye"></i> Ver
                    </a>
                    <a href="editar_cliente.php?id=1" class="btn btn-outline-success btn-sm">
  ...
  <!-- FOOTER -->
  <footer>
    <p class="mb-0">© 2025 Veterinaria Tessa | Búsqueda de Clientes</p>
  </footer>
